...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (
    ...
    function typeWord() {
      ...
      if (prefersReducedMotion) {
        ...
        brandWordText.textContent =
          word;

        if (brandCursor) {

          brandCursor.classList.add(
            'hide'
          );
  ...
  if (
    ...
    function updateParallax() {
      ...
      const rect =
        productShowcase.getBoundingClientRect();
      ...
      if (
        ...
        showcaseBgImg.style.transform =
          `scale(1.15) translateY(${offset}px)`;
  ...
  const howStepsContainer =
    document.getElementById(
      'howSteps'
    );

  const howConnectorFill =
    document.getElementById(
      'howConnectorFill'
    );
  ...
  if (
    ...
    function updateConnector() {
      ...
      const rect =
        howStepsContainer.getBoundingClientRect();
      ...
      if (isMobileLayout()) {
        ...
        howConnectorFill.style.width =
          '100%';

        howConnectorFill.style.height =
          `${progress * 100}%`;
